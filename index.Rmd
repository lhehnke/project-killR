...
killers_df %>% 
  ...
  DT::datatable(filter = "bottom", style = "bootstrap", extensions = "Buttons", options = list(dom = "Bfrtip", buttons = list("copy", list(extend = "collection", filename = "Serial_killeRs", buttons = list(list(extend = "csv", filename = "Serial_killeRs"), list(extend = "excel", filename = "Serial_killeRs"), list(extend = "pdf", filename = "Serial_killeRs")), text = "Download"))))
```
